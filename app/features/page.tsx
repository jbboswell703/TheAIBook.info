      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <FeatureCard 
            ...
            description="Continuous improvements and new features to keep your website up-to-date
        ...
        <div className="bg-primaryy/10 rounded-lg p-8 md:p-12 mb-20">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-primary/10">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 py-2 border-b border-gray-100">
                  ...
                  <div className="text-center"><Check className="h-4 w-4 text-accent mx-auto" /></div>
                  <div className="text-center"><Check className="h-4 w-4 text-accent mx-auto" /></div>
                </div>
                
                <div className="grid grid-cols-3 gap-4 py-2 border-b border-gray-100">
                  <div className="text-gray-700">Color Palettes</div>
                  <div className="text-center text-gray-700">5</div>
                  <div className="text-center text-gray-700">Unlimited</div>
                </div>
                
                <div className="grid grid-cols-3 gap-4 py-2 border-b border-gray-100">
                  <div className="text-gray-700">Custom Code</div>
                  <div className="text-center text-gray-700">Limited</div>
                  <div className="text-center"><Check className="h-4 w-4 text-accent mx-auto" /></div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 py-2">
                  <div className="text-gray-700">Team Access</div>
                  <div className="text-center">1 user</div>
                  <div className="text-center text-gray-700">Unlimited</div>
                </div>
              </div>
            </div>
